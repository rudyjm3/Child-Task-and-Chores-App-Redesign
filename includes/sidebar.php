<?php
// includes/sidebar.php - Desktop sidebar navigation (parent pages only, visible at 1024px+)
// Active item detected from the current script name; no page variables required.
// Renders nothing for child accounts.
...
$sbName = trim((string)($_SESSION['name'] ?? ($_SESSION['username'] ?? 'Parent')));
